...
if uploaded_file is not None:
    ...
    batterij_aanwezig = st.radio(
    "Is er een batterij/ accu aanwezig?",
    ["Ja", "Nee"],
    index=None,
    )
    ...
    - $Aantal\ HBE-O\ voor\ leveringen\ uit\ het\ net = omvang\ levering\ in\ kWh\ * 0,0036 * 4 * net\ deel\ groen\ percentage$
    ...
    if batterij_aanwezig == "Ja":
        df1['HBE'] = df1.apply(bereken_HBE, axis=1)
    else:
